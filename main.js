...
alert("Se não tiver 26 colunas é só clicar em ok na coluna 26, tanto no n1 quanto no n2");
...
function descriptado(n1, n2, m1, m2) {
    ...
    // Verificando se temos 26 resultados
    if (resultados.length === 26) {
        // Separando os resultados em duas linhas de 13
        var linha1 = resultados.slice(0, 13);
        var linha2 = resultados.slice(13, 26);
